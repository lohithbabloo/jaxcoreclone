  ...
  return (
    <div>
      ...
      <div className='flex mt-9 flex-col items-center text-white font-Poppins'>
        ...
        <h1 className='text-4xl'>Works how you want it to</h1>
        {/* cards */}
        <div className='card-wrapper flex mt-10 items-center justify-center w-[700px] flex-wrap gap-[30px]'>
          <div className='card1 w-[300px] h-[300px] rounded-xl flex flex-col justify-center items-center text-center gap-[10px] bg-zinc-800 text-white p-5'>
        ...
        <div className='car w-[300px] h-[300px] rounded-xl flex flex-col justify-center items-center text-center gap-[10px] bg-zinc-800 p-5'>
